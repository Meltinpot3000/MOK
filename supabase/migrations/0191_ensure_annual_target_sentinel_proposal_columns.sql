-- 0191_ensure_annual_target_sentinel_proposal_columns.sql
-- Sicherstellen: smart_proposal + anchor_fit (falls 0189-Doppelnummer die Spalten nicht anlegte).
...
comment on column app.annual_targets.smart_proposal is
  'Pending Sentinel-Vorschläge: { title, formulation{S,M,A,R,T}, smart_check, improvement_notes, generated_at }.';

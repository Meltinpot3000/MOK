  ...
  return (
    <div className="space-y-6">
      <header className="brand-card p-6">
        <p className="text-xs font-semibold uppercase tracking-wide text-zinc-500">Strategische Stossrichtungen</p>
        <h1 className="mt-2 text-2xl font-semibold text-zinc-900">Strategische Stossrichtungen</h1>
        <p className="mt-1 text-sm text-zinc-600">
          Verknuepfe strategische Stossrichtungen mit Industrien, Geschaeftsmodellen und Betriebsmodellen.
        </p>
      </header>
        ...
        <div className="space-y-3">
          {links.strategicDirections.length === 0 ? (
            <p className="brand-surface p-3 text-sm text-zinc-600">
              Noch keine strategischen Stossrichtungen vorhanden.
            </p>
          ) : (

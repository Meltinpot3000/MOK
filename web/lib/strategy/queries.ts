...
export async function getStrategicMetrics(organizationId: string, cycleInstanceId: string) {
...
export async function getStrategicChallenges(organizationId: string, cycleInstanceId: string) {
  const supabase = await createSupabaseServerClient();
  const { data } = await supabase
    .schema("app")
...
export async function getStrategicDirections(organizationId: string, cycleInstanceId: string) {
  const supabase = await createSupabaseServerClient();
  const { data } = await supabase
    .schema("app")
...
export async function getAnnualTargets(organizationId: string, cycleInstanceId: string) {
  const supabase = await createSupabaseServerClient();
  const { data } = await supabase
    .schema("app")
    .from("annual_targets")
...
export async function getAnalysisEntries(organizationId: string, cycleInstanceId: string) {
  const supabase = await createSupabaseServerClient();
  const { data } = await supabase
    .schema("app")

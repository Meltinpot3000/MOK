...
export async function getAnalysisEntriesForCycle(organizationId: string, cycleInstanceId: string) {
...
export async function getApprovedAnalysisLinks(organizationId: string, cycleInstanceId: string) {
  const supabase = await createSupabaseServerClient();
  const { data } = await supabase
    .schema("app")
...
export async function getAnalysisLinkDrafts(organizationId: string, cycleInstanceId: string) {
  const supabase = await createSupabaseServerClient();
  const { data } = await supabase
    .schema("app")
...
export async function getAnalysisClusters(organizationId: string, cycleInstanceId: string) {
  const supabase = await createSupabaseServerClient();
  const { data } = await supabase
    .schema("app")
...
export async function getAnalysisClusterMembers(organizationId: string, cycleInstanceId: string) {
  const supabase = await createSupabaseServerClient();
  const { data } = await supabase
    .schema("app")
...
export async function getAnalysisGapFindings(organizationId: string, cycleInstanceId: string) {
  const supabase = await createSupabaseServerClient();
  const { data } = await supabase
    .schema("app")
